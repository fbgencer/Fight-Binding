...
fig = figure("Name","Drawing test");
gp = lattice_drawer(fig,30,30);

gp.set_title("Graphene C_{6}");
gp.set_xlabel("X-Coordinates");
gp.set_ylabel("Y-Coordinates");


o1 = gp.draw('line',3,3,3,10);
o2 = gp.draw('line',3,10,25,20);
o3 = gp.draw('line',25,20,3,3);
